...
public class model {
    ...
    public void query() throws SQLException {
        ...
        String export=">sqlite3 -header -csv test2.db \"select * from info;\" > tracks.csv";
        ResultSet rs    = stmt.executeQuery(export);
       /* Statement stmt  = connection.createStatement();
...
//            }
    ...
    public void insert(String name, String age,String test ,String result) throws SQLException {
